...
SELECT 
  *,
  ...
  -- 3. Recalculate Delinquency (Max 15)
  CASE 
    WHEN recalculate_delinquency = 0 THEN 15 
    WHEN recalculate_delinquency = 1 THEN 11
    WHEN recalculate_delinquency BETWEEN 2 AND 3 THEN 9 
    WHEN recalculate_delinquency BETWEEN 4 AND 5 THEN 7
    WHEN recalculate_delinquency BETWEEN 6 AND 7 THEN 5 
  ...
  -- 5. Salah Generate (Max 15)
  CASE 
    WHEN salah_generate = 0 THEN 15 
